...
public class ActionAddReplacement implements IAction {
    ...
    public ActionAddReplacement(String stage, IIngredient original, IItemStack replacement, boolean defDrop) {
        this(stage, getStatesFromIngredient(original), replacement != null ? getStatesFromStack(CraftTweakerMC.getItemStack(replacement)) : Collections.singletonList(Blocks.STONE.getDefaultState()), defDrop);
    }
